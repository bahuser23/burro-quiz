...
acertouDez.addEventListener('click', () =>{
    ...
    elevenstQuest.style.display = "block";
})

acertouOnze.addEventListener('click', () => {
    elevenstQuest.style.display = "none";
    twelvendQuest.style.display = "block";
})

acertouDoze.addEventListener('click', () =>{
    twelvendQuest.style.display = "none";
    thirteenrdQuest.style.display = "block";
})

acertouTreze.addEventListener('click', () =>{
    thirteenrdQuest.style.display = "none";
    fourteenthQuest.style.display = "block";
})

acertouQuatorze.addEventListener('click', () =>{
    fourteenthQuest.style.display = "none";
    fifteenthQuest.style.display = "block";
})

acertouQuinze.addEventListener('click', () =>{
    fifteenthQuest.style.display = "none";
